...
export default function Historia() {
    return (
        <View>
            <Text style={estilo.titulo}>História do Nintendo Entertainment System</Text>

            <Image style={estilo.capa} source={console} />

            <Text style={estilo.descricao}>Um dos consoles mais emblemáticos da Nintendo até hoje foi lançado em 1983 no Japão com o nome de Famicom (Family Computer), mas só em 1985 o console chegou aos Estados Unidos, com um visual totalmente reformulado e um novo nome, Nintendo Entertainment System (NES).
