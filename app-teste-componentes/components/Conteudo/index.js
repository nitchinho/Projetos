...
import estilos from "./styleConteudo";
...
export default function Conteudo() {
    return (
        <View style={estilos.container}>
            ...
            <Text style={estilos.paragrafo}>Casado com a atriz Latanya Richardson, que conhecera ainda nos tempos de Morehouse College.</Text>
            ...
            <Image style={estilos.imagem} source={Filme}/>
        </View>
    )
}