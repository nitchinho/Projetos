...
import estiloValor from '../ItemComparacao/estilos';
            ...
            <SafeAreaView>
                  <ScrollView>
                        <View style={[estiloGlobal.container, estiloGlobal.odd]}>
                              <Text style={estiloValor.textoValores}>Ano</Text>
                              <Text style={estiloValor.textoValores}>Salário</Text>
                              <Text style={estiloValor.textoValores}>Inflação</Text>
                              <Text style={estiloValor.textoValores}>Cresc. Salarial</Text>
                              <Text style={estiloValor.textoValores}>Status Salário</Text>
                        </View>
