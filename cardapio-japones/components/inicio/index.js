  ...
  return (
    <View style={style.container}>
      <View style={style.logoArea}>
        ...
        <Text style={style.logoTitle}>CATÁLOGO KIDS ZONE</Text>
      </View>
      <TextInput maxLength={20} keyboardType='default' onChangeText={(inputTerm) => handleSearch(inputTerm)} value={termo} placeholder='O que você procura?' style={style.inputSearch}></TextInput>
